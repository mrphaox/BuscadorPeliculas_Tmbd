...
const   SearchBar: React.FC<SearchBarProps> = ({ onSearch }) => {
  ...
  return (
    <div className="flex flex-col items-center">
      <form onSubmit={handleSubmit} className="flex flex-wrap justify-center mt-6 space-x-2 text-black">
        <input
          type="text"
          value={query}
        ...
        <button
          type="submit"
          className="mt-2 sm:mt-0 px-4 py-2 bg-gray-900 text-white rounded-md flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
        >
